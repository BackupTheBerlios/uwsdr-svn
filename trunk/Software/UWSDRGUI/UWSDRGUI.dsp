...
# ADD CPP /nologo /MT /W3 /GR /GX /O2 /Ob0 /I "C:\wxWidgets-2.6.3\lib\vc_dll\msw" /I "." /I "C:\wxWidgets-2.6.3\include" /I "..\PortAudio\portaudio\pa_common" /D "WIN32" /D "__WXMSW__" /D "WXUSINGDLL" /D "_WINDOWS" /D "NOPCH" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MTd /W3 /Gm /GR /GX /ZI /Od /I "C:\wxWidgets-2.6.3\lib\vc_dll\mswd" /I "." /I "C:\wxWidgets-2.6.3\include" /I "..\PortAudio\portaudio\pa_common" /D "WIN32" /D "_DEBUG" /D "__WXMSW__" /D "__WXDEBUG__" /D "WXUSINGDLL" /D "_WINDOWS" /D "NOPCH" /FR /FD /GZ /c
# SUBTRACT CPP /YX
...
# ADD LINK32 wxbase26d.lib wxmsw26d_core.lib wxbase26d_net.lib dttsp.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib fftw3.lib /nologo /subsystem:windows /debug /machine:I386 /out:"../Debug/UWSDR.exe" /pdbtype:sept /libpath:"..\DttSP++\Debug" /libpath:"C:\wxWidgets-2.6.3\lib\vc_dll" /libpath:"..\FFTW"
