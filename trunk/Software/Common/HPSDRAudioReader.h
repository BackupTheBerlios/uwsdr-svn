...
#ifndef	HPSDRAudioReader_H
#define	HPSDRAudioReader_H

#include "DataReader.h"
#include "HPSDRReaderWriter.h"

class CHPSDRAudioReader : public IDataReader {
    public:
	CHPSDRAudioReader(CHPSDRReaderWriter* hpsdr);
	virtual ~CHPSDRAudioReader();
