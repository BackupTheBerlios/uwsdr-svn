...
#ifndef __AX88796_H__
#define __AX88796_H__
...
#define DCR_BYTE_WIDE		(u8)0x00	// byte-wide DMA transfers
#define DCR_WORD_WIDE		(u8)0x01	// word-wide DMA transfers

// Constants for the NIC_RCV_CONFIG register.
#define RCR_BROADCAST	(u8)0x04	// receive broadcast packets
#define RCR_MULTICAST	(u8)0x08	// receive multicast packets
#define RCR_ALL_PHYS	(u8)0x10	// receive ALL directed packets
#define RCR_MONITOR	(u8)0x20	// don't collect packets
#define RCR_INT_ACT	(u8)0x40
...
*
*****************************************************************************/
void ax88796Write(u8 address, u8 data);

//**************************************************************************
// void ax88796WriteBlock
//**************************************************************************
